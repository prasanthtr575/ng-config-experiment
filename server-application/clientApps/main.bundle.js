...
var AppComponent = (function () {
    function AppComponent(_http) {
        ...
        this._url = __WEBPACK_IMPORTED_MODULE_3_environments_environment__["a" /* environment */].apiUrl + 'mock'; // URL to web api
    }
    AppComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.getData().subscribe(function (data) { return _this.title = data.data; });
    };
